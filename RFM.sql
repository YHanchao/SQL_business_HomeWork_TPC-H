...
UPDATE RFM SET TYPE_NAME = 'ACTIVE' WHERE CUS_TYPE = 2;
UPDATE RFM SET TYPE_NAME = 'NORMAL' WHERE CUS_TYPE = 1;
UPDATE RFM SET TYPE_NAME = 'INACTIVE' WHERE CUS_TYPE = 0;
UPDATE RFM SET TYPE_NAME = 'UNBUY' WHERE CUS_TYPE = -1;
